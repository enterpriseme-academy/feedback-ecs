...
| [terraform_remote_state.build](https://registry.terraform.io/providers/hashicorp/terraform/latest/docs/data-sources/remote_state) | data source |
...
|------|-------------|------|---------|:--------:|
| <a name="input_name"></a> [name](#input\_name) | Name for the vpc | `string` | `"feedback-app"` | no |
| <a name="input_port"></a> [port](#input\_port) | Port for the application | `number` | `5000` | no |
